...
5. [Model Layer & Concerns](#model-layer--concerns)
6. [Authentication Without Devise](#authentication-without-devise)
7. [State as Records, Not Booleans](#state-as-records-not-booleans)
8. [Views & Turbo/Hotwire Patterns](#views--turbohotwire-patterns)
9. [Background Jobs](#background-jobs)
10. [Testing Approach](#testing-approach)
11. [What They Deliberately Avoid](#what-they-deliberately-avoid)
12. [Naming Conventions](#naming-conventions)
13. [Product Design Inferences](#product-design-inferences)
